        ...
        <div class=\"col-xs-12\">
          <div class=\"box box-warning\">
            <div class=\"box-header\">
              <h3 class=\"box-title\">Daftar ".ucfirst($table_name)."</h3>
              <div class=\"box-tools\">
                <?php echo \$pagination ?>
              </div><br><br>
              <div class=\"row\" style=\"margin-bottom: 10px\">
                <div class=\"col-md-4\">
                  <?php echo anchor(site_url('".$c_url."/create'),'<i class=\"fa fa-plus\" aria-hidden=\"true\"></i> &nbsp; ".$table_name." Baru', 'class=\"btn btn-primary\"'); ?>
                </div>
