...
if ( ! function_exists('GenCaptchaNumber'))
{
    function GenCaptchaNumber(){
        $angka1 = rand(1,10);
        $angka2 = rand(1,10);
        $operators = array('+','*');
        ...
        $data['answer'] = $answer;
        $data['qtext'] = $angka1.' '.$operator.' '.$angka2;
        return $data; 
    }
}


if ( ! function_exists('GenCaptchaNumber2'))
{
    function GenCaptchaNumber2(){
        $angka1 = rand(1,10);
        $angka2 = rand(1,10);
        $operators = array('+','-','*');
        $operator = rand(0, count($operators) - 1);
